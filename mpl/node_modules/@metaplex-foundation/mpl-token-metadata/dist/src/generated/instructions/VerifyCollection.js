...
function createVerifyCollectionInstruction(accounts) {
    const { metadata, collectionAuthority, payer, collectionMint, collection, collectionMasterEditionAccount, } = accounts;
