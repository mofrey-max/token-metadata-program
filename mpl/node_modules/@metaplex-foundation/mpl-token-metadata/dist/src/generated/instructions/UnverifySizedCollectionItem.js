...
function createUnverifySizedCollectionItemInstruction(accounts) {
    const { metadata, collectionAuthority, payer, collectionMint, collection, collectionMasterEditionAccount, collectionAuthorityRecord, } = accounts;
