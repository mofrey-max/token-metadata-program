...
function createApproveCollectionAuthorityInstruction(accounts) {
    const { collectionAuthorityRecord, newCollectionAuthority, updateAuthority, payer, metadata, mint, } = accounts;
