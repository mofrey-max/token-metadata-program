...
function createMintNewEditionFromMasterEditionViaVaultProxyInstruction(accounts, args) {
    const { newMetadata, newEdition, masterEdition, newMint, editionMarkPda, newMintAuthority, payer, vaultAuthority, safetyDepositStore, safetyDepositBox, vault, newMetadataUpdateAuthority, metadata, tokenVaultProgram, } = accounts;
