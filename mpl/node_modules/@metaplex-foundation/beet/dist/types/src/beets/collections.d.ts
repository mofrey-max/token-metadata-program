 ...
 * @category beet/collection
 */
export declare function fixedSizeUint8Array(len: number): FixedSizeBeet<Uint8Array>;
/**
 ...
 * @category TypeDefinition
 */
export declare type CollectionsTypeMapKey = 'Array' | 'FixedSizeArray' | 'UniformFixedSizeArray' | 'Buffer' | 'Uint8Array';
/**
 * @category TypeDefinition
 */
